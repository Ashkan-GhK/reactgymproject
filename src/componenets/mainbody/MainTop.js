...
function MainTop() {
	...
	return (
		<div className="maintop">
			...
			<div className={active ? "maintop__text active" : "maintop__text" }>"
			...
			<div className="maintop__middle">
				<img src="https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fHdvcmtvdXR8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80" alt="work out"  />
			</div>
			<div className="maintop__left">
